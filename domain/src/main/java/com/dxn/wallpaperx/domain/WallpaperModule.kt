...
object WallpaperModule {
    ...
    @Singleton
    @Named("pixabay")
    fun providePixabayRepo(pixabayApi: PixabayApi): RemoteRepository = PixabayRepository(pixabayApi)
    ...
    ): WallpaperRepository = WallpaperRepositoryImpl(remoteRepository, localRepository)
}
